...
import { PurposeTable } from './purpose.table';
import { PurposeForm } from './purpose.form';

const TITLE = Navigations.DataWarehousePurpose;

export const PurposeIndex = () => {
  ...
  return (
    <>
      ...
      <PurposeForm open={openCreate} onClose={() => setOpenCreate(false)} />
    </>
  );
};
