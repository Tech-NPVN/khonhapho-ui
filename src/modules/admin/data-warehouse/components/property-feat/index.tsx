...
import { PropertyFeatTable } from './property-feat.table';
import { PropertyFeatForm } from './property-feat.form';

const TITLE = Navigations.DataWarehousePropertyFeat;

export const PropertyFeatIndex = () => {
  ...
  return (
    <>
      ...
      <PropertyFeatForm open={openCreate} onClose={() => setOpenCreate(false)} />
    </>
  );
};
