...
import { ContractTypeTable } from './contract-type.table';
import { ContractTypeForm } from './contract-type.form';

const TITLE = Navigations.DataWarehouseContractType;

export const ContractTypeIndex = () => {
  ...
  return (
    <>
      ...
      <ContractTypeForm open={openCreate} onClose={() => setOpenCreate(false)} />
    </>
  );
};
