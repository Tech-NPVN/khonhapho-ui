...
const FormComponent: React.FC<ModalMeetingProps> = ({ type, defaultValue, onClose }) => {
...
const ModalMeeting: React.FC<ModalMeetingProps> = ({ open, type, defaultValue, onClose }) => {
  return (
    <>
      {open && (
        <ModalWithHash
